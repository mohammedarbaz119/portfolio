...
export default function Project({
  ...
  return (
    ...
    >
      <section className="bg-black/60 max-w-[42rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[21rem] hover:bg-gray-800 transition sm:group-even:pl-8 dark:text-white">
