...
export default function Project({
  ...
  return (
    ...
    >
      <section className="bg-black/40 max-w-[42rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[20rem] hover:bg-gray-700 transition sm:group-even:pl-8 dark:text-white">
